...
import styles from "./css/Payment2.module.css";

export const Payment2: FunctionComponent = () => {
  ...
  const onRectangleRectangle23Click = useCallback(() => {
    ...
    <div className={styles.paymentDiv}>
      ...
      <div className={styles.homeBannerDiv}>
        ...
        <div className={styles.groupDiv1}>
          ...
          <img className={styles.groupIcon1} alt="" src="group-254.svg" />
          ...
          <div className={styles.groupDiv3}>
            ...
            <img className={styles.groupIcon4} alt="" src="group-274.svg" />
          </div>
        </div>
      ...
      <div className={styles.groupDiv21}>
        ...
        <div className={styles.groupDiv23} onClick={onGroupContainer22Click}>
          <div className={styles.rectangleDiv21} />
          <b className={styles.debitCreditCard}>Wallet</b>
        </div>
        <div className={styles.groupDiv24}>
          <div
            className={styles.rectangleDiv21}
            data-scroll-to="rectangleRectangle"
          />
          <b className={styles.debitCreditCard}>Net Banking</b>
        </div>
        <div
          className={styles.rectangleDiv24}
          onClick={onRectangleRectangle23Click}
        />
          ...
          <div className={styles.formDiv1}>
            <div className={styles.elementsInputsLarge60px}>
              <div className={styles.inputDiv}>
                ...
                <div className={styles.typeYourEMail}>Bank2</div>
              </div>
            </div>
            <div className={styles.elementsInputsLarge60px1}>
              <div className={styles.inputDiv}>
                <div className={styles.baseDiv1} />
                <div className={styles.typeYourEMail}>Bank1</div>
              </div>
            </div>
            <div className={styles.typeYourEMail2}>Note :</div>
            <div className={styles.elementsInputsLarge60px2}>
              <div className={styles.inputDiv}>
                <div className={styles.baseDiv1} />
                <div className={styles.typeYourEMail}>Bank 3</div>
              </div>
            </div>
          </div>
          <div className={styles.typeYourEMail4}>
